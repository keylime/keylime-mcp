...
func TestChatFlow(t *testing.T) {
	...
	t.Run("reset", func(t *testing.T) {
		rc := helpers.NewMCPTestClient(t, []helpers.MockLLMResponse{
	...
	t.Run("sse_history_replay", func(t *testing.T) {
		hc := helpers.NewMCPTestClient(t, []helpers.MockLLMResponse{
